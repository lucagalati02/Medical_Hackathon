...
def diagnosing(diagnosis, diagnosis_attempt):
    attempt = openai.Completion.create(engine="text-davinci-003", prompt=(
        "Can you tell me if these 2 patient diagnoses are similar? Answer in 'True' or 'False'.\n1. " + diagnosis + "\n2. " + diagnosis_attempt), max_tokens=2)
